	...
	$(function() {
		function mmenuInit() {
			...
			if(wi <= '992') {
				...
				$(".mmenu-init" ).remove();
				$("#navigations").clone().addClass("mmenu-init").insertBefore("#navigations").removeAttr('id').removeClass('style-1 style-2').find('ul').removeAttr('id');
